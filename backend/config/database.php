    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                ...
                // Trick 02 — timeouts on every I/O boundary.
                // Connection timeout: fail fast if the DB host is unreachable.
                PDO::ATTR_TIMEOUT                 => env('DB_CONNECT_TIMEOUT', 3),
                PDO::MYSQL_ATTR_CONNECT_TIMEOUT   => env('DB_CONNECT_TIMEOUT', 3),
            ]) : [],
        ],
